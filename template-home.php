    ...
    <div class="resume__header row">
      ...
      <ul class="resume__contact__list offset-lg-2 col-lg-10 mt__1-5rem">
        <li class="resume__contact__item mt__1rem">
          <a href="https://api.whatsapp.com/send?1=pt_BR&phone=5562982741818&text=Ol%C3%A1,%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20os%20%20seus%20servi%C3%A7os."
        ...
        <li class="resume__contact__item mt__1rem">
          <a href="https://www.linkedin.com/in/darly-agostinho-45682722/" class="resume__contact__link" target="_blank"
            rel="noopener">
            <div class="resume__contact__icon__wrapper">
            ...
            <span class="ml__half__rem resume__contact__link__desc">linkedin.com/in/darly-agostinho-45682722/</span>
          </a>
        </li>
      </ul>
    </div>
